...
class CNNAudioClassifier(nn.Module):
    ...
    def __init__(self, num_classes: int = 4, input_channels: int = 1) -> None:
        ...
        logging.verbose("Initializing CNNAudioClassifier")
...
if __name__ == "__main__":
    ...
    model = CNNAudioClassifier(num_classes=num_classes, input_channels=input_channels)
    ...
    batch_size = 8
    n_mels = 128
    seq_len = 200  # Variable length supported
    dummy_input = torch.randn(batch_size, input_channels, n_mels, seq_len)
