...
def interactive_audio_viewer(processed_dir: str = "data/processed/train", 
    ...
    def update_display(spec_file):
        ...
        ax_spec.clear()
        img = librosa.display.specshow(S_db, x_axis='time', y_axis='mel', ax=ax_spec,
                                     sr=SAMPLE_RATE, hop_length=512)  # standard hop_length in librosa
